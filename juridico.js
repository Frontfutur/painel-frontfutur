...
/* ---------------------------------------------------------------- modelo */
const FRENTES=[
 {id:"f1",code:"F1",name:"Modelos de documentos",color:"var(--f1)"},
 {id:"f2",code:"F2",name:"Contratos internos",color:"var(--f2)"},
 {id:"f3",code:"F3",name:"Contratos externos",color:"var(--f3)"},
 {id:"f4",code:"F4",name:"Societário e estrutura",color:"var(--f4)"}
];
const STATUSES=[
